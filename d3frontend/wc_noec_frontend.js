...
$($.post("/load_ui", {}, function(data, status){ if (status == "success"){load_ui(data)}}));

setInterval(function( event ){
  let Dm32  = $('input[name=Dm32]').val()
  let Th23 = $('input[name=Th23]').val()
  let dcp = $('input[name=dcp]').val()
  let L_km = $('input[name=L_km]').val()
...
function update_input(obj){
    ...
    ui_els.text_elements[0].update(tick);
