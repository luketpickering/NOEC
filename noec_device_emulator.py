...
def startEmulator( devicefd,clientfd,client_tty):
  ...
  while True:
    ...
    os.write(devicefd,str.encode('{{') +  obj_to_msg({"cmd": "UPDATE","hist":hist, "tick": tick, "states": states, "ADCs": vals, "ADCStates": [True, True, True, True], "noise":noise,"ml_mode":"GD", "start_ml":False, "slow_load":False, "L_km":1300})+ str.encode('}}'))
